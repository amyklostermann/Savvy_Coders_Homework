...
const user3Tasks = data.filter(task => task.userId === 3);
const user3IncompleteTasks = user3Tasks.filter(task => !task.completed);
let totalUser3Tasks = user3IncompleteTasks.reduce((sum, num) => sum + user3IncompleteTasks, 0)
console.log (totalUser3Tasks);
